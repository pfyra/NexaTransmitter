...
void NexaTransmitter::setSwitch(bool on, short recipient, unsigned long remote, short repeat, short level)
{
...
void NexaTransmitter::transmit(bool blnOn, short recipient, short level)
{
  ...
  delayMicroseconds(267);     // bit of radio shouting before we start. 
  digitalWrite(txPin, LOW);
  delayMicroseconds(2580);     // low for 9900 for latch 1
